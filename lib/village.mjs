...
export const MILESTONES = [
  ...
  // The island runs out of buildable land somewhere past three hundred houses, and
  // `gridSize` cannot grow. So at a hundred and fifty the village learns to keep the
