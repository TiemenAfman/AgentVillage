...
export const MILESTONES = [
  ...
  // `TRADES` in lib/layout.mjs puts them on the town's lattice just outside it.
  { id: 'sawmill', at: 55, civicType: 'sawmill', label: 'The sawmill' },
  { id: 'smithy', at: 60, civicType: 'smithy', label: 'The smithy' },
  // The next two trades (Plans/stal-en-veld.md), one in each gap the ladder still had below
  // the bridge, and placed by `TRADES` like the two above. The bakery first, at 65 between the
  // smithy and the statue: it is the small shop, and the one a town that has had its windmill
  // grinding since 30 wants next. The stable at 75, the first rung in the twenty-settler
  // stretch between the statue and the bridge: its paddock makes it the bigger yard, and a
  // horse is what a town keeps once it has somewhere to ride to.
  { id: 'bakery', at: 65, civicType: 'bakery', label: 'The bakery' },
