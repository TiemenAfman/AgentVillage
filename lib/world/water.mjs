...
export function carveWater(grid, seed, { rivers = 2, lakes = 1, scale = 1 } = {}) {
  ...
  // speaking of, and a river on one would be a drain. The catchment threshold below does that
  // excluding by itself; the peak is what the lakes measure themselves against.
  let peak = 0, peakAt = -1;
