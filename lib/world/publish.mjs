 ...
 */
export function publishWorld(seed, outDir, { envelopeM = 1024, radiusM = 208, erosion = undefined, onProgress = null } = {}) {
  ...
  const manifest = {
    ...
    landmasses: masses.map((m) => ({
      index: m.index, areaHa: m.areaHa, centroid: m.centroid, bounds: m.bounds, peak: m.peak,
    })),
    landings,
    rivers: field.rivers,
    lakes: field.lakes,
