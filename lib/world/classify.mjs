...
export function makeClassifier(seed, shape, relief) {
  ...
  /**
   * @param slope  pass it in from a baked grid where you have one; recomputing it here costs
   *               four more height evaluations, each of which costs a coast evaluation.
   */
  function classify(x, z, h = relief.height(x, z), d = shape.coast(x, z), slope = null) {
