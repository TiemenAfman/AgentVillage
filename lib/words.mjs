...
// A name from an id: stable, pronounceable and village-flavoured. It lives here rather
// than in lib/village.mjs - where it was, next to the scanner's aggregation - because the
// two callers that are not the scanner have no business importing that file. lib/sea.mjs
// hands out a name to every player who joins and holds no village at all.
