...
// The two API paths a visitor may reach. Everything a visitor is shown has to be
// listed here by hand, one at a time, and /api/props earns its place by being scenery:
// shapes, places and sizes, naming no file and no folder.
const PUBLIC_API = new Set(['/api/hello', '/api/props']);
