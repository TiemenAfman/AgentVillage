...
// Nothing on it yet: no landing (so no dock and no boat - shared/quay.mjs derives both from
// the landing, and a bundle without one gets none), no harbours, no town, no buildings.
// The guards and the Codex houses come later and will come through the crowd, not this.
//
