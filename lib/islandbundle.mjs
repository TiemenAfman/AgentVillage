...
export function buildBundle({ config, village, props = [], crops = [], placements = null, id = null, keeper = null } = {}) {
  ...
  return {
    ...
    placements: placedAt(placements && placements.at, ctx),
...
export function parseBundle(obj, { terrainHash = null } = {}) {
  ...
  const actual = terrainHash || makeTerrain(bundle.island.seed, { size, polders }).hash;
