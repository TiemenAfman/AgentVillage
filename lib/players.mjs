...
// player who is blocking it costs a fraction (lib/hostility.mjs). Anything above these is
// dropped here, so a client cannot smuggle a flag the next version might give a meaning to.
export const POSE = Object.freeze({ MOVING: 1, SWIMMING: 2, RUNNING: 4, AIRBORNE: 8, BLOCKING: 16 });
const POSE_MASK = 31;
