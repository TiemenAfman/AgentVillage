...
// taken off every blow from an agent (lib/hostility.mjs armorOf). Anything above these is
// dropped here, so a client cannot smuggle a flag the next version might give a meaning to.
export const POSE = Object.freeze({ MOVING: 1, SWIMMING: 2, RUNNING: 4, AIRBORNE: 8, BLOCKING: 16, SHIELD_LEFT: 32, SHIELD_RIGHT: 64 });
const POSE_MASK = 127;
