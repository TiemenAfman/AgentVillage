...
test('crowd batches stay constant, new skin and face parts track and hide with their owner', () => {
  ...
  assert.equal(scene.children.length, 27, 'eleven articulated body, two appearance layers, six hats, four chore tools, three barrow batches, one hammer batch');
  ...
  assert.equal(scene.children.length, 27, 'no mesh per person');
