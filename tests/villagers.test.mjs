...
test('crowd batches stay constant, new skin and face parts track and hide with their owner', () => {
  ...
  assert.equal(scene.children.length, 23, 'eleven articulated body, six hats, four chore tools, one gold bar, one hammer batch');
  ...
  assert.equal(scene.children.length, 23, 'no mesh per person');
