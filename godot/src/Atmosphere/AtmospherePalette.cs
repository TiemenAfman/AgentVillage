...
public static class AtmospherePalette
{
	...
	[
		(0.0f, new AtmosphereState(
			...
			MoonColour: new Color(0.60f, 0.72f, 1.00f), MoonEnergy: 0.32f,
			SkyTop: new Color(0.045f, 0.062f, 0.130f),
			SkyHorizon: new Color(0.130f, 0.165f, 0.280f),
			GroundHorizon: new Color(0.075f, 0.095f, 0.150f),
			GroundBottom: new Color(0.020f, 0.028f, 0.050f),
			SkyEnergy: 0.85f,
			AmbientColour: new Color(0.34f, 0.44f, 0.76f), AmbientEnergy: 0.30f,
		...
		(21.0f, new AtmosphereState(
			...
			MoonColour: new Color(0.60f, 0.72f, 1.00f), MoonEnergy: 0.30f,
			SkyTop: new Color(0.052f, 0.072f, 0.145f),
			SkyHorizon: new Color(0.150f, 0.180f, 0.300f),
			GroundHorizon: new Color(0.080f, 0.100f, 0.160f),
			GroundBottom: new Color(0.022f, 0.030f, 0.055f),
			SkyEnergy: 0.88f,
