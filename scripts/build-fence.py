...
It writes assets/fence/agentvillage-fence.blend and bakes it to web/js/fence-mesh.js.
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT / 'agentvillage-fence.blend'))
